...
const ProjectCard = ({project}) => {
    ...
    return (
        <div className='my-10'>
            <Card
                className="max-w-lg transition duration-300 ease-in-out hover:shadow-2xl bg-gray-800 dark:bg-gray-900"
            ...
            >
                ...
                <div className='flex flex-1 text-gray-900 dark:text-gray-100 gap-4'>
                    <button className="max-w-xl px-4 py-2 flex gap-2 rounded-full text-center dark:bg-gray-50 dark:text-gray-800 dark:hover:bg-gray-300 text-gray-900 bg-white hover:bg-gray-200 transition duration-300 ease-in-out">
...
: "bg-white dark:bg-gray-50 text-gray-900 dark:text-gray-800 hover:bg-gray-200"
}
`}
                        >
                            <FiExternalLink />
